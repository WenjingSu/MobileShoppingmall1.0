						...
						<div class="am-modal am-modal-no-btn" id="doc-modal-1">
							...
							<div class="add-dress">
								...
								<div class="am-cf am-padding">
									<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">修改验证</strong> / <small>Password</small></div>
								</div>
								<hr/>
								...
								<div class="am-u-md-12 am-u-lg-8" style="margin-top: 20px;">
										...
										<div class="am-form-group">
											<label for="user-name" class="am-form-label">当前手机号:</label>
											<div id="tel1" class="${user.u_phone}">
												${user.u_phone}
											</div>
										</div>
										<br>
										...
										<div class="am-form-group">
											...
											<a id="phone1" href="frontmanger/userphone2.jsp" onclick="return false"><input type="button" value="提交"></a>
